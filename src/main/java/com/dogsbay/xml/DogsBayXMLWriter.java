...
/**<p><code>XMLWriter</code> takes a DOM4J tree and formats it to a
  ...
  */
public class DogsBayXMLWriter extends XMLWriter {
    ...
    public DogsBayXMLWriter( OutputStream out, DogsBayOutputFormat format) throws UnsupportedEncodingException {
        super( out, format);
    ...
    public DogsBayXMLWriter( DogsBayOutputFormat format) throws UnsupportedEncodingException {
        super( format);
    ...
    public DogsBayXMLWriter( Writer writer, DogsBayOutputFormat format) throws UnsupportedEncodingException {
        super( format);
...
//		System.out.print( "["+((PositionedWriter)writer).getPosition()+"]");
	...
	protected void writeDocType( DocumentType docType) throws IOException {
	    if (DEBUG) System.out.println( "DogsBayXMLWriter.writeDocType( "+docType+")");
...
//						System.out.println( internalDecl.toString());
	        ...
	        // before it (two separators here produced a double blank line).
	...
	protected void writeEntity( Entity entity) throws IOException {
		...
		if (DEBUG) System.out.println( "DogsBayXMLWriter.writeEntity( "+name+")");
	...
	protected void writeEntityRef( String name) throws IOException {
		if (DEBUG) System.out.println( "DogsBayXMLWriter.writeEntityRef( "+name+")");
//		if ( !name.equals( "amp")) { // Should never happen.
//		    writeEntityRef( entity.getName());
//		} else {
//			writer.write( "&");
//		}
	...
	protected String escapeElementEntities( String text) {
		if (DEBUG) System.out.println( "DogsBayXMLWriter.escapeElementEntities( "+text+")");
	...
	protected String escapeAttributeEntities(String text) {
		if (DEBUG) System.out.println( "DogsBayXMLWriter.escapeAttributeEntities( "+text+")");
...
//	}
	...
	private static class PositionedWriter extends Writer {
		private DogsBayXMLWriter parent = null;
		private int pos = 0;
		private int column = 0;
		private Writer out;
		
		public PositionedWriter( DogsBayXMLWriter parent, Writer out) {
			this.out = out;
			this.parent = parent;
		}
