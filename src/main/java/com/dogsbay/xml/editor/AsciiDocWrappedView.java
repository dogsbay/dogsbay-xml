...
/**
 * Wrapped view for rendering AsciiDoc with syntax highlighting.
 */
public class AsciiDocWrappedView extends FoldingWrappedPlainView {
    private boolean highlight = false;
    private AsciiDocScanner lexer;
    private boolean lexerValid;
    private XmlContext context = null;

    public AsciiDocWrappedView(XmlContext context, Element elem) {
        super(elem, true);
