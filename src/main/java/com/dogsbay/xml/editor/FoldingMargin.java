...
public class FoldingMargin extends JComponent {
	...
	private static final ImageIcon FOLDED_ICON = ImageUtilities.createSilhouetteImage( DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/Folded.gif"), UIManager.getColor( "textText"));
	private static final ImageIcon UNFOLDED_ICON = ImageUtilities.createSilhouetteImage( DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/Unfolded.gif"), UIManager.getColor( "textText"));
