...
public class AttributeList extends JList {
	...
	private static final ImageIcon USED_ATTRIBUTE_ICON = DogsBayImageLoader.get().getImage( "com/dogsbay/xml/designer/icons/AttributeIcon.gif");
	private static final ImageIcon USED_ATTRIBUTE_REQUIRED_ICON = DogsBayImageLoader.get().getImage( "com/dogsbay/xml/designer/icons/RequiredAttributeIcon.gif");
	private static final ImageIcon UNUSED_ATTRIBUTE_ICON = DogsBayImageLoader.get().getImage( "com/dogsbay/xml/designer/icons/VirtualAttributeIcon.gif");
	private static final ImageIcon UNUSED_ATTRIBUTE_REQUIRED_ICON = DogsBayImageLoader.get().getImage( "com/dogsbay/xml/designer/icons/VirtualRequiredAttributeIcon.gif");
