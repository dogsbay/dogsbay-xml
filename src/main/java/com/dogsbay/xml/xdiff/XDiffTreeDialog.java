...
public class XDiffTreeDialog extends JDialog {
	...
	private DogsBayDocument mergeDocument = null;
	private DogsBayDocument diffDocument = null;
...
//			treePanel.setBorder( new EmptyBorder( 0, 0, 0, 0));
	 ...
	 */
	public void show(DogsBayDocument document,String baseFile,String modFile,DogsBayAIEditor editor) 
	{
		this.editor = editor;
	...
	class GotoNextDiffAction extends AbstractAction {
		 ...
		 */
	 	public GotoNextDiffAction() {
			...
			putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NextDiff16.gif"));
	...
	class GotoPreviousDiffAction extends AbstractAction {
		 ...
		 */
	 	public GotoPreviousDiffAction() {
			...
			putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/PreviousDiff16.gif"));
	...
	class GotoLastDiffAction extends AbstractAction {
		 ...
		 */
	 	public GotoLastDiffAction() {
			...
			putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/LastDiff16.gif"));
	...
	class GotoFirstDiffAction extends AbstractAction {
		 ...
		 */
	 	public GotoFirstDiffAction() {
			...
			putValue( MNEMONIC_KEY, Integer.valueOf( 'F'));
			putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/FirstDiff16.gif"));
	...
	class ShowMergeTreeAction extends AbstractAction {
		 ...
		 */
	 	public ShowMergeTreeAction() {
			...
			putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/Merge16.gif"));
	 	...
	 	public void actionPerformed( ActionEvent event) 
		{
	 		try
			{
	 			...
	 			mergeDocument = new DogsBayDocument(url, true);
	 			mergeDocument.load();
	 			...
	 			diffTreeLabel.setIcon( DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/Diff16.gif"));
	 			...
	 			mergeTreeLabel.setIcon( DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/Merge16.gif"));
...
//			putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/DocumentIcon.gif"));
	 	...
	 	public void actionPerformed( ActionEvent event) 
		{
	 		...
	 		DogsBayDocument document = new DogsBayDocument(formattedXML, true);
	...
	private void loadDeletedState(XmlElementNode diffNode,DogsBayDocument mergeDocument)
	{
