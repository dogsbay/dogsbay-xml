...
import com.dogsbay.dogsbayaieditor.grammar.NamedXPathProperties;
 ...
 * @author Dogsbay
 */
public class Navigator extends ViewTreePanel implements DogsBayDocumentListener {
	...
	private static final ImageIcon BADGE_ICON = DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/Arrow6.gif");

	private static final ImageIcon PLAY_ICON = DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/Play16.gif");
	private static final ImageIcon XPATH_ICON = DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/XPathSearch16.gif");
	private static final ImageIcon XPATH_BADGE_ICON = DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/XPathSearchBadge16.gif");

	private static final ImageIcon ALL_ICON = DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16IconAll.gif");
	private static final ImageIcon ALL_BADGE_ICON = DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16BadgeIconAll.gif");
	private static final ImageIcon PROPERTIES_ICON = DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/PreferencesBadge16.gif");
	private static final ImageIcon ELEMENT_ICON = DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/ShowElementValues16.gif");
	private static final ImageIcon ATTRIBUTE_ICON = DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/ShowAttributes16.gif");

	public static final ImageIcon[] ELEMENT_ICONS = 
	{ 
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16Icon1.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16Icon2.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16Icon3.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16Icon4.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16Icon5.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16Icon6.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16Icon7.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16Icon8.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16Icon9.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16Icon10.gif")
	};

	public static final ImageIcon[] ELEMENT_BADGE_ICONS = 
	{ 
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16BadgeIcon1.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16BadgeIcon2.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16BadgeIcon3.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16BadgeIcon4.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16BadgeIcon5.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16BadgeIcon6.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16BadgeIcon7.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16BadgeIcon8.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16BadgeIcon9.gif"),
		DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/NavigatorElement16BadgeIcon10.gif")
	};
	 ...
	 */
	public Navigator( DogsBayAIEditor parent, NavigatorProperties properties) {
		...
		tree.addTreeSelectionListener( new TreeSelectionListener() {
			public void valueChanged( TreeSelectionEvent e) {
				...
				if ( path != null) {
					...
					if ( element != null) {
						// Sync with current view on single click
						ViewPanel current = editor.getCurrent();
...
//		(new Exception()).printStackTrace();
		if ( isVisible()) {
			editor.setStatus( "Updating Navigator ...");
			editor.setWait( true);
...
//				System.out.println( "Showing Tree!");
				...
				forceSelectedElement( editor.getView().getSelectedElement());
//				System.out.println( "Tree Shown!");
	...
	public void setDocument( DogsBayDocument document) {
		...
		if ( document != null) {
			settings = editor.getView().getNavigatorSettings();
