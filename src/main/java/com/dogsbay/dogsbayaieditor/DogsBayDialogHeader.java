 ...
 */
public class DogsBayDialogHeader extends JDialog {
     ...
     * @param modal
     */
    public DogsBayDialogHeader(JFrame frame, boolean modal) {
        super(frame,modal);
	 ...
	 * also sets the dialog title and dialog description and editor icon
	 * @return the QPanel
	 */
	public QPanel buildHeader() {
		...
		ImageIcon icon = DogsBayImageLoader.get().getImage(
