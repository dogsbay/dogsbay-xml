 ...
 * @author Dogsbay
 */
public class FindInFilesDialog extends DogsBayDialog {
	 ...
	 */
	public FindInFilesDialog( DogsBayAIEditor parent, ConfigurationProperties props) {
		super( parent, true);
				...
				*/
			 	if ( value == JFileChooser.APPROVE_OPTION) {
				 	...
				 	for(int cnt=0;cnt<files.length;++cnt) {
				 		...
				 		try {
							filesBuffer.append(DogsBayURLUtilities.getURLFromFile(files[cnt]));
