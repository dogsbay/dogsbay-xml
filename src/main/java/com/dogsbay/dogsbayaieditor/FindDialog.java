...
/**
 * The find dialog for the DogsBayAIEditor editor.
 *
 * @version	$Revision: 1.8 $, $Date: 2005/08/23 14:28:46 $
 * @author Dogsbay
 */
public class FindDialog extends DogsBayDialog {
	 ...
	 */
	public FindDialog( JFrame parent, ConfigurationProperties props, DogsBayAIEditor editor) {
		super( parent, true);
	...
	private JPanel createAdvancedPanel() {
		...
		xpathBox.addItemListener( new ItemListener() {
			public void itemStateChanged( ItemEvent event) {
				if(editor != null) {
					editor.setWait( true);
		            editor.setStatus( "Updating Document Model ...");
//					 Run in Thread!!!
		            Runnable runner = new Runnable() {
		                public void run()  {
		                    try {
		                    	...
		                    	boolean error = editor.getDocument().isError();
		                        ...
		                        MessageHandler.showError( editor, "Error - Cannot update document", "Find Error");
		                    } finally {
