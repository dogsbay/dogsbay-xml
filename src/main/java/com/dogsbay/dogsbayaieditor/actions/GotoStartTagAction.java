 ...
 */
 public class GotoStartTagAction extends AbstractAction {
	 ...
	 */
 	public GotoStartTagAction( DogsBayAIEditor parent) {
		...
		putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/GotoStartTag16.gif"));
