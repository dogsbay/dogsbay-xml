...
import com.dogsbay.dogsbayaieditor.ToolsDeCapitalizeDialog;
...
public class ToolsDeCapitalizeAction extends AbstractAction {
     ...
     */
    public ToolsDeCapitalizeAction( DogsBayAIEditor parent, Editor editor, ConfigurationProperties props) {
...
//          }
     ...
     */
    private String deCapitalize(DogsBayDocument document, boolean deCapitalizeElements, 
     ...
     * @return the decapitalized document as a string
     */
    private String deCapitalize(DogsBayDocument document, String xpath, boolean deCapitalizeElements, 
