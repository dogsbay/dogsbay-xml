...
public class ToolsRemoveUnusedNSAction extends AbstractAction {
     ...
     */
    public ToolsRemoveUnusedNSAction( DogsBayAIEditor parent, Editor editor, ConfigurationProperties props) {
...
//      }
    ...
    private String removeUnusedNS(DogsBayDocument document) throws Exception {
