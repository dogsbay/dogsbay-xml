...
import com.dogsbay.dogsbayaieditor.SubstituteCharactersDialog;
 ...
 */
 public class SubstituteCharactersAction extends AbstractAction {
	 ...
	 */
 	public SubstituteCharactersAction( DogsBayAIEditor parent, ConfigurationProperties props) {
		super( "Convert Characters to Entities...");
		
		if (DEBUG) System.out.println( "SusbtituteCharactersAction( "+parent+", "+props+")");
		
		putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/ConvertToEntities16.gif"));
