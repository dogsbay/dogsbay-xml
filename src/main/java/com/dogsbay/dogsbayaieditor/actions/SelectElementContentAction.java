 ...
 */
 public class SelectElementContentAction extends AbstractAction {
	 ...
	 */
 	public SelectElementContentAction( DogsBayAIEditor parent) {
		...
		//putValue( ACCELERATOR_KEY, KeyStroke.getKeyStroke( KeyEvent.VK_E, InputEvent.CTRL_DOWN_MASK+InputEvent.SHIFT_DOWN_MASK, false));
		putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/SelectElementContent16.gif"));
