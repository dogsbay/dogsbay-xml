 ...
 */
 public class SelectElementAction extends AbstractAction {
	 ...
	 */
 	public SelectElementAction( DogsBayAIEditor parent) {
		...
		putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/SelectElement16.gif"));
