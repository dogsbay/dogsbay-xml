...
import com.dogsbay.dogsbayaieditor.ToolsLowercaseDialog;
...
public class ToolsLowercaseAction extends AbstractAction {
     ...
     */
    public ToolsLowercaseAction( DogsBayAIEditor parent, Editor editor, ConfigurationProperties props) {
...
//          }
    ...
    private String lowercase(DogsBayDocument document, boolean lowercaseElements, 
    ...
    private String lowercase(DogsBayDocument document, String xpath, boolean lowercaseElements, 
