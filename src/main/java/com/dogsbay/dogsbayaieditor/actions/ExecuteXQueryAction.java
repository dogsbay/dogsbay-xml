...
import com.dogsbay.dogsbayaieditor.scenario.ExecuteXQueryDialog;
...
public class ExecuteXQueryAction extends AbstractAction {
	 ...
	 */
 	public ExecuteXQueryAction( DogsBayAIEditor parent) {
 	...
 	public void actionPerformed( ActionEvent e) {
		...
		if ( !dialog.isCancelled()) {
			...
			// PHASE 3: XQuery disabled during Saxon upgrade
