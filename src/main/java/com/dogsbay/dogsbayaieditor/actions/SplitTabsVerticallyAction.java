 ...
 */
 public class SplitTabsVerticallyAction extends AbstractAction {
	 ...
	 */
 	public SplitTabsVerticallyAction( DogsBayAIEditor parent) {
 		super( "Split Vertically");

		putValue( MNEMONIC_KEY, Integer.valueOf( 'V'));
		putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/SplitVertical16.gif"));
