...
import com.dogsbay.dogsbayaieditor.ToolsAddNodeToNamespaceDialog;
...
public class ToolsAddNodeToNamespaceAction extends AbstractAction {
     ...
     */
    public ToolsAddNodeToNamespaceAction( DogsBayAIEditor parent, Editor editor, ConfigurationProperties props) {
...
//          }
     ...
     */
    public String addNamespaceToNode(DogsBayDocument document, String xpathPredicate, Namespace newNs) throws Exception {
     ...
     * @throws Exception
     */
    public void changeAttribute(DogsBayDocument document, List attributeList, Namespace newNs) throws Exception {
