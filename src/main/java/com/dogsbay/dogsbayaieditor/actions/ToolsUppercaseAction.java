...
import com.dogsbay.dogsbayaieditor.ToolsUppercaseDialog;
...
public class ToolsUppercaseAction extends AbstractAction {
     ...
     */
    public ToolsUppercaseAction( DogsBayAIEditor parent, Editor editor, ConfigurationProperties props) {
...
//          }
     ...
     */
    private String uppercase(DogsBayDocument document, boolean uppercaseElements, 
     ...
     * @return the converted document as a string
     */
    private String uppercase(DogsBayDocument document, String xpath, boolean uppercaseElements, 
