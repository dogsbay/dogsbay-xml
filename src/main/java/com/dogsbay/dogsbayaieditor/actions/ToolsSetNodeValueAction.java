...
import com.dogsbay.dogsbayaieditor.ToolsSetNodeValueDialog;
...
public class ToolsSetNodeValueAction extends AbstractAction {
     ...
     */
    public ToolsSetNodeValueAction( DogsBayAIEditor parent, Editor editor, ConfigurationProperties props) {
...
//          }
     ...
     */
    private String setNodeValue(DogsBayDocument document, String xpathPredicate, String value) throws Exception {
     ...
     * @throws Exception
     */
    private void changeAttribute(DogsBayDocument document, List attributeList, String value) throws Exception {
