...
import com.dogsbay.dogsbayaieditor.SaveRemoteDocumentDialog;
 ...
 */
 public class SaveAsRemoteAction extends AbstractAction {
	 ...
	 */
 	public SaveAsRemoteAction( DogsBayAIEditor parent, ConfigurationProperties props) {
		...
		putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/SaveAsRemote16.gif"));
