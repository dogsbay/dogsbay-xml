...
import com.dogsbay.dogsbayaieditor.ToolsChangeNSPrefixDialog;
...
public class ToolsChangeNSPrefixAction extends AbstractAction {
     ...
     */
    public ToolsChangeNSPrefixAction( DogsBayAIEditor parent, Editor editor, ConfigurationProperties props) {
     ...
     */
    private String changeNSPrefix(DogsBayDocument document, Vector newNamespaces)  {
