...
import com.dogsbay.dogsbayaieditor.ToolsSortNodeDialog;
...
public class ToolsSortNodeAction extends AbstractAction {
     ...
     *            the parent frame.
     */
    public ToolsSortNodeAction(DogsBayAIEditor parent, Editor editor,
    ...
    private String sortByXPath(DogsBayDocument document,
    ...
    private Vector treeWalk(DogsBayDocument document, List nodeList, Vector nodes) throws Exception {
    ...
    private void removeOccurences(String xpath, DogsBayDocument document)
            throws Exception {
    ...
    private void insertNodes(DogsBayDocument document, Vector nodes,
            boolean isAscending) throws Exception {
