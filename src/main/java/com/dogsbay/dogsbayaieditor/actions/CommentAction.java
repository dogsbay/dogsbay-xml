 ...
 */
 public class CommentAction extends AbstractAction {
	 ...
	 */
 	public CommentAction( DogsBayAIEditor parent) {
		super( "Comment");
		...
		putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/xml/editor/icons/Comment16.gif"));
	...
	public void setUncomment( boolean enabled) {
		if ( enabled) {
			...
			putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/xml/editor/icons/Uncomment16.gif"));
		} else {
