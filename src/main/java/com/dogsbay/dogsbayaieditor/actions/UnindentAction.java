 ...
 public class UnindentAction extends AbstractAction {
	 ...
	 */
 	public UnindentAction() {
		...
		putValue( ACCELERATOR_KEY, KeyStroke.getKeyStroke( KeyEvent.VK_TAB, InputEvent.SHIFT_DOWN_MASK, false));
		putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/xml/editor/icons/Unindent16.gif"));
