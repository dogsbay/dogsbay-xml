 ...
 */
 public class SplitTabsHorizontallyAction extends AbstractAction {
	 ...
	 */
 	public SplitTabsHorizontallyAction( DogsBayAIEditor parent) {
 		super( "Split Horizontally");

		putValue( MNEMONIC_KEY, Integer.valueOf( 'H'));
		putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/SplitHorizontal16.gif"));
