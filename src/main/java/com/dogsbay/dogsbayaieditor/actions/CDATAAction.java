 ...
 */
 public class CDATAAction extends AbstractAction {
	 ...
	 */
 	public CDATAAction(  DogsBayAIEditor parent) {
		super( "CDATA");
...
//		putValue( ACCELERATOR_KEY, KeyStroke.getKeyStroke( KeyEvent.VK_K, InputEvent.CTRL_DOWN_MASK, false));
		putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/CDATA16.gif"));
	...
	public void setUnCDATA( boolean enabled) {
		if ( enabled) {
			...
			putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/UnCDATA16.gif"));
		} else {
			putValue( NAME, "CDATA");
			putValue( SHORT_DESCRIPTION, "CDATA");
			putValue( SMALL_ICON, DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/CDATA16.gif"));
