 ...
 * @author Dogsbay
 */
public class ScenarioPropertiesDialog extends DogsBayDialogHeader {
...
//		executeButton.setFont( executeButton.getFont().deriveFont( Font.PLAIN));
	...
	public void show( ScenarioProperties properties, DogsBayDocument document, Vector names) {
		show( properties, document, names, null);
	}

	public void show( ScenarioProperties properties, DogsBayDocument document, Vector names, ScenarioPropertiesDialogListener listener) {
