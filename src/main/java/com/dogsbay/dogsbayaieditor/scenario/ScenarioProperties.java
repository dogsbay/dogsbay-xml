...
//	public static final int OUTPUT_TO_BROWSER		= 2; // @deprecated
	...
	public static final int PROCESSOR_SAXON_XSLT2	= 2;  // Saxon 9.x
	public static final int PROCESSOR_SAXON_XSLT3	= 3;  // Saxon-HE 12.7
...
//		set( ID, "SP"+date.getTime());
	...
	public XElement exportScenario( URL url) {
		//XElement root = new XElement( "scenario", "http://www.dogsbay.ai/dogsbay-editor/"+Identity.getIdentity().getVersion()+"/");
	...
	private static int convertProcessor( String value) {
		...
		if ( value != null) {
			if ( value.equals( "default")) {
				...
				// Old Saxon 1.X - map to default for backwards compatibility
				result = PROCESSOR_DEFAULT;
			} else if ( value.equals( "saxon2")) {
				result = PROCESSOR_SAXON_XSLT2;
			} else if ( value.equals( "saxon3")) {
				result = PROCESSOR_SAXON_XSLT3;
			}
		}
