 ...
 * @author Dogsbay
 */
public class ParameterManagementDialog extends DogsBayDialogHeader {
	private static final Dimension SIZE 					= new Dimension( 300, 250  + DogsBayDialogHeader.HEADER_HEIGHT);
