 ...
 * @author Dogsbay
 */
public class ScenarioSelectionDialog extends DogsBayDialog {
	 ...
	 */
	public ScenarioSelectionDialog(JFrame parent, ConfigurationProperties props, String confirm, boolean toggleAll,
	 ...
	 */
	public void showDialog(Vector properties, ScenarioProperties defaultScenario) {
