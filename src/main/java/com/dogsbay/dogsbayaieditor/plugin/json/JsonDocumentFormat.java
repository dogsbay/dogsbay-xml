...
/**
 * Document format for JSON files (.json, .jsonc, .geojson).
 */
public class JsonDocumentFormat implements DocumentFormat {
    ...
    public String convertToHtml(String sourceText) {
        // Simple pretty-print for preview
