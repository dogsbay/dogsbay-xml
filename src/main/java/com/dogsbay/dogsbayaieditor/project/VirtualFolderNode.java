...
public class VirtualFolderNode extends BaseNode implements Comparator {
	private static final ImageIcon ICON = DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/project/icons/VirtualFolderIcon.gif");
	private static final ImageIcon EXPANDED_ICON = DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/project/icons/SelectedVirtualFolderIcon.gif");
