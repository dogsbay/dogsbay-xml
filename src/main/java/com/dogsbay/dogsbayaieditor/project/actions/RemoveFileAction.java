...
public class RemoveFileAction extends AbstractAction {
	 ...
	 */
 	public RemoveFileAction( Project project) {
 		super( "Remove File");
 		
 		this.project = project;

	 	putValue( MNEMONIC_KEY, Integer.valueOf( 'v'));
 		putValue( SHORT_DESCRIPTION, "Remove a File from the Project");
	 ...
	 */
 	public void actionPerformed( ActionEvent e) {
	 	BaseNode node = project.getSelectedNode();
	  	int result = MessageHandler.showConfirm( "Are you sure you want to remove this file \""+node.getName()+"\"?");
