 ...
 * @author Dogsbay
 */
public class DocumentNode extends BaseNode implements DogsBayDocumentListener {
...
// Implementation of the DogsBayDocumentListener
	public void documentUpdated( DogsBayDocumentEvent e) {
		if ( e.getType() == DogsBayDocumentEvent.SAVED) {
			updateState();
...
//			properties.setState( DocumentProperties.STATE_VALID);
	...
	public void parse() {
		...
		try {
			doc = new DogsBayDocument( properties.getURL());
			doc.load();
		} catch (Exception e) {}
