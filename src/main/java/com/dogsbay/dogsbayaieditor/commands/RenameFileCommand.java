...
/**
 * Rename/move a file and rewrite every reference to it (maps, conrefs,
 * links, images). Dry-run by default: the result is the plan; nothing
 * changes unless {@code apply} is true.
 *
