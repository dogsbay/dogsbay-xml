...
/**
 * One broken reference found by check-links.
 *
 * @param source    absolute path of the referencing file
 * @param line      1-based line of the referencing element
 * @param attribute the referencing attribute (href, conref, keyref, ...)
 * @param value     the attribute value as written
 * @param reason    why it's broken ("target not found", "key not defined")
 */
