...
/**
 * Action to pull from the remote repository.
...
public class PullAction extends AbstractAction {
    ...
    public PullAction(GitPanel gitPanel) {
        super("Pull");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (git == null) {
            JOptionPane.showMessageDialog(gitPanel,
                ...
                "Pull Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        new SwingWorker<GitCommandResult, Void>() {
            ...
            protected GitCommandResult doInBackground() throws Exception {
                return GitCommandRunner.runGitCommand(repoRoot, "pull");
            }
            ...
            protected void done() {
                try {
                    ...
                    // a merge rewrites the files it brings in.
                    gitPanel.reloadOpenBuffers();

                    if (result.isSuccess()) {
                        JOptionPane.showMessageDialog(gitPanel,
                            "Pull completed successfully.\n" + result.getMessage(),
                            "Pull Successful", JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(gitPanel,
