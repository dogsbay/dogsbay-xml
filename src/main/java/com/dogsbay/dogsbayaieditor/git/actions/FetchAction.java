...
/**
 * Action to fetch from the remote repository.
...
public class FetchAction extends AbstractAction {
    ...
    public FetchAction(GitPanel gitPanel) {
        super("Fetch");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        new SwingWorker<GitCommandResult, Void>() {
            ...
            protected GitCommandResult doInBackground() throws Exception {
                return GitCommandRunner.runGitCommand(repoRoot, "fetch");
            }
                ...
                try {
                    ...
                    if (result.isSuccess()) {
                        JOptionPane.showMessageDialog(gitPanel,
                            ...
                            "Fetch Successful", JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(gitPanel,
