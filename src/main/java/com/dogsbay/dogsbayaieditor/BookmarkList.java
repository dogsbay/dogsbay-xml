...
public class BookmarkList extends JPanel {
	private static final ImageIcon BOOKMARK_ICON = DogsBayImageLoader.get().getImage( "com/dogsbay/dogsbayaieditor/icons/Bookmarks16.gif");
	 ...
	 */
	public BookmarkList( DogsBayAIEditor _parent, Vector bookmarks) {
