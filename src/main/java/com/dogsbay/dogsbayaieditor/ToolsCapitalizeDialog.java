...
/**
 * Dialog used by the ToolsCapitalizeAction class
 *
 * @version	$Revision: 1.13 $, $Date: 2004/11/04 19:21:49 $
 */
public class ToolsCapitalizeDialog extends DogsBayDialog {
     ...
     * @param modal
     */
    public ToolsCapitalizeDialog(JFrame frame,ConfigurationProperties props) {
    ...
    private JPanel buildOptionsPanel() {
        ...
        options.setLayout(new FormLayout(4,1));
                       
        
        elementsRadio = new JRadioButton("Capitalize Elements Only");
        attributeRadio = new JRadioButton("Capitalize Attributes Only");
        elementsAndAttributesRadio = new JRadioButton("Capitalize Elements and Attributes");
