 ...
 */
public class NonXMLDocumentChooserDialog extends DogsBayDialog {
	...
	private int type = 0;
	private String[] stringFileEncoding = { "UTF-8", "UTF-16", "US-ASCII", "ISO-8859-1", "ISO-8859-2", "ISO-8859-3",
			"ISO-8859-4",
	...
	private void inputLocationButtonPressed() {
		try {
			...
			if (value == JFileChooser.APPROVE_OPTION) {
				...
				Boolean isItAFile = Boolean.valueOf(file.isFile());
		...
		if (type == TYPE_TEXT) {
			...
			try {
				...
				if (file.isFile()) {
					...
					try {
						urlInputLocation = com.dogsbay.xml.DogsBayURLUtilities.getURLFromFile(file);
						finished = true;
	...
	public void showDialog(int typeOfFile) {
