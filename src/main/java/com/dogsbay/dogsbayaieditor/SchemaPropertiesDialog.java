...
import com.dogsbay.dogsbayaieditor.grammar.TagCompletionPropertiesDialog;
 ...
 * @author Dogs bay
 */
public class SchemaPropertiesDialog extends DogsBayDialog {
	 ...
	 */
	public SchemaPropertiesDialog( DogsBayAIEditor parent) 
	{
		super( parent, true);
...
//		setDefaultScenarioButton.setPreferredSize( new Dimension( setDefaultScenarioButton.getPreferredSize().width, 20));
	 ...
	 * 
	 */
	public void show( XMLGrammarImpl grammar, Vector tagCompletionSchemas, SchemaDocument viewerSchema) {
