...
/**
 * Dialog used by the ToolsLowercaseAction class
 *
 * @version	$Revision: 1.14 $, $Date: 2004/11/04 19:21:49 $
 */
public class ToolsLowercaseDialog extends DogsBayDialog {
     ...
     * @param modal
     */
    public ToolsLowercaseDialog(JFrame frame,ConfigurationProperties props) {
    ...
    private JPanel buildOptionsPanel() {
        ...
        elementsRadio = new JRadioButton("Lowercase Elements Only");
        attributeRadio = new JRadioButton("Lowercase Attributes Only");
        elementsAndAttributesRadio = new JRadioButton("Lowercase Elements and Attributes");
