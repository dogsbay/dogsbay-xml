...
class XPathQueryPluginTest {

    @Test
    void testPluginMetadata() {
        XPathQueryPlugin plugin = new XPathQueryPlugin();
        assertEquals("com.dogsbay.xpath-query", plugin.getId());
        assertEquals("XPath Query", plugin.getName());
