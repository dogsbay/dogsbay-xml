...
class GitPluginTest {
    ...
    void testPluginMetadata() {
        ...
        assertEquals("com.dogsbay.git", plugin.getId());
        assertEquals("Git Integration", plugin.getName());
    ...
    @Test
    void testGitPanelNullBeforeActivation() {
        GitPlugin plugin = new GitPlugin();
        assertNull(plugin.getGitPanel());
    }
}
